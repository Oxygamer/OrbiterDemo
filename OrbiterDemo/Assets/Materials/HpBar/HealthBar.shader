...
Shader "Shader Forge/HealthBar" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _Fill;
            float CalculateFill( float X , float Fill ){
            if(X<Fill)
            {
            return 1;
            }else{
...
////// Emissive:
                ...
                return fixed4(finalColor,(node_603*CalculateFill( i.uv0.r , _Fill )));
            }
            ENDCG
        }
        Pass {
